...
#they all have one value :o
#for index in outputBins:
#	print(index, " - > ", outputBins[index].values)

var = outputBins[0].values[0] * outputBins[1].values[0] * outputBins[2].values[0]
print(var)