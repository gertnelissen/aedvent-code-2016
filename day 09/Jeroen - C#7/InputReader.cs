...
namespace Jeroen
{
    ...
    public static class InputReader
    {
        ...
        {
            return Assembly.GetExecutingAssembly().GetManifestResourceStream($"Jeroen.input.{kind}.txt");
        }

        public static string ReadAllText()
        {
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"Jeroen.input.real.txt"))
            using (var reader = new StreamReader(stream))
            {
